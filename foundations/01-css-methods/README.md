...
<!--
 External CSS uses a separate .css file linked to your HTML for clean, multi-page styling;

 Internal CSS is written within <style> tags in the HTML <head> for single-page styles;

  Inline CSS is added directly to HTML elements using the style attribute for quick, specific changes.
 -->
